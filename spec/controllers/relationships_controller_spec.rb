...
describe RelationshipsController do
  ...
  #       post :create, {:relationship => { "user" => "invalid value" }}, valid_session
  #       assigns(:relationship).should be_a_new(Relationship)
  #     end
  ...
  #       Relationship.any_instance.should_receive(:update).with({ "user" => "" })
  #       put :update, {:id => relationship.to_param, :relationship => { "user" => "" }}, valid_session
  #     end
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       Relationship.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => relationship.to_param, :relationship => { "user" => "invalid value" }}, valid_session
  #       assigns(:relationship).should eq(relationship)
  #     end
